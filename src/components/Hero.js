     ...
     <div className="  md:col-start-1  md:col-endt-8 lg:col-start-2 col-span-4 p-10 lg:max-w-5xl lg:col-end-4 sm:max-w-5xl py-5 sm:py-48 lg:py-56 ">
       ...
       <div className="mt-10  flex items-center justify-start">
         ...
         >
           <button
             type="button"
             className="rounded bg__all px-12 sm:px-14 py-2 sm:py-3 dark:bg-gray-100 text-sm bg__all font-semibold dark:text-gray-800 text-green-300 shadow-sm ring-1 ring-inset ring-green-300 hover:bg-gray-700 dark:ring-gray-300 hover:border-bottom-4"
           >
             Contact
           </button>
         </Link>
